...
im=(ImageView) findViewById(R.id.home2);
    ...
    public void onClick(View v) {
        ...
        today[0]=new SimpleDateFormat("dd").format(new java.util.Date());
        current[0] =preferences1.getString("current","");
        if(current[0]=="")
        {
            check=0;
        }
        ...
        {
            check=Integer.parseInt(current[0]);
        }


        if(Integer.parseInt(today[0]) == check)
        {
            orderNum=preferences.getString("orderNum","");
            n=Integer.parseInt(orderNum);
            n++;
            orderNum=n.toString();
            SharedPreferences preferences=getSharedPreferences("PREFS",0);
            SharedPreferences.Editor editorr=preferences.edit();
            editorr.putString("orderNum",orderNum);
            editorr.commit();
        ...
        else
        {
            ...
            orderNum=n.toString();
            SharedPreferences preferences=getSharedPreferences("PREFS",0);
            SharedPreferences.Editor editore=preferences.edit();
            editore.putString("orderNum",orderNum);
            editore.commit();

            SharedPreferences preferences1=getSharedPreferences("sharePref",MODE_PRIVATE);
            SharedPreferences.Editor editor1=preferences1.edit();
            editor1.putString("current", today[0]);
            editor1.commit();
